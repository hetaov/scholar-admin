...
# Original file moved to: services.providers.evaluator
# This shim:
...
#     target module, so runtime code inside services.providers.evaluator that reads module-level
...
_target = _importlib.import_module("services.providers.evaluator")
_target_name = "services.providers.evaluator"
_shim_name = __name__
