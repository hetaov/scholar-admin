...
# Original file moved to: services.learning.conversation_graph
# This shim:
...
#     target module, so runtime code inside services.learning.conversation_graph that reads module-level
...
_target = _importlib.import_module("services.learning.conversation_graph")
_target_name = "services.learning.conversation_graph"
_shim_name = __name__
