...
# Original file moved to: services.learning.session_task
# This shim:
...
#     target module, so runtime code inside services.learning.session_task that reads module-level
#     globals (e.g. SESSION_LLM_TIMEOUT_SECONDS, ...) always sees
#     the monkey-patched value, even when tests patch via the old shim path.
#   - Underscore-prefixed symbols like _release_session_slot are fully exported.
import sys as _sys
import importlib as _importlib

_target = _importlib.import_module("services.learning.session_task")
_target_name = "services.learning.session_task"
_shim_name = __name__
