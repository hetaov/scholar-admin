...
# Original file moved to: services.learning.translation_task
# This shim:
...
#     target module, so runtime code inside services.learning.translation_task that reads module-level
...
_target = _importlib.import_module("services.learning.translation_task")
_target_name = "services.learning.translation_task"
_shim_name = __name__
