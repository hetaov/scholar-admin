...
# Original file moved to: services.providers.tts
# This shim:
...
#     target module, so runtime code inside services.providers.tts that reads module-level
...
_target = _importlib.import_module("services.providers.tts")
_target_name = "services.providers.tts"
_shim_name = __name__
