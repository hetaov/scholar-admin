...
# Original file moved to: services.routes.system
# This shim:
...
#     target module, so runtime code inside services.routes.system that reads module-level
...
_target = _importlib.import_module("services.routes.system")
_target_name = "services.routes.system"
_shim_name = __name__
