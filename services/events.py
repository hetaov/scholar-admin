...
# Original file moved to: services.models.events
# This shim:
...
#     target module, so runtime code inside services.models.events that reads module-level
...
_target = _importlib.import_module("services.models.events")
_target_name = "services.models.events"
_shim_name = __name__
