...
# Original file moved to: services.routes.evaluation
# This shim:
...
#     target module, so runtime code inside services.routes.evaluation that reads module-level
...
_target = _importlib.import_module("services.routes.evaluation")
_target_name = "services.routes.evaluation"
_shim_name = __name__
