...
# Original file moved to: services.infra.auth
# This shim:
...
#     target module, so runtime code inside services.infra.auth that reads module-level
...
_target = _importlib.import_module("services.infra.auth")
_target_name = "services.infra.auth"
_shim_name = __name__
