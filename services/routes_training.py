...
# Original file moved to: services.routes.training
# This shim:
...
#     target module, so runtime code inside services.routes.training that reads module-level
...
_target = _importlib.import_module("services.routes.training")
_target_name = "services.routes.training"
_shim_name = __name__
