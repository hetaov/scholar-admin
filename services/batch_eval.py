...
# Original file moved to: services.providers.batch_eval
# This shim:
...
#     target module, so runtime code inside services.providers.batch_eval that reads module-level
...
_target = _importlib.import_module("services.providers.batch_eval")
_target_name = "services.providers.batch_eval"
_shim_name = __name__
