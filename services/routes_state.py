...
# Original file moved to: services.routes.state
# This shim:
...
#     target module, so runtime code inside services.routes.state that reads module-level
...
_target = _importlib.import_module("services.routes.state")
_target_name = "services.routes.state"
_shim_name = __name__
