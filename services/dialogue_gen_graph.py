...
# Original file moved to: services.learning.dialogue_gen_graph
# This shim:
...
#     target module, so runtime code inside services.learning.dialogue_gen_graph that reads module-level
#     globals (e.g. DIALOGUE_GEN_MAX_RETRY, RECALL_MIN, ...) always sees
#     the monkey-patched value, even when tests patch via the old shim path.
#   - Underscore-prefixed symbols like _initial_state are fully exported.
import sys as _sys
import importlib as _importlib

_target = _importlib.import_module("services.learning.dialogue_gen_graph")
_target_name = "services.learning.dialogue_gen_graph"
_shim_name = __name__
