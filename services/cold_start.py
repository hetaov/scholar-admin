...
# Original file moved to: services.learning.cold_start
# This shim:
...
#     target module, so runtime code inside services.learning.cold_start that reads module-level
...
_target = _importlib.import_module("services.learning.cold_start")
_target_name = "services.learning.cold_start"
_shim_name = __name__
