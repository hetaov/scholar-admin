...
# Original file moved to: services.build.build_sentence_fixed
# This shim:
...
#     target module, so runtime code inside services.build.build_sentence_fixed that reads module-level
...
_target = _importlib.import_module("services.build.build_sentence_fixed")
_target_name = "services.build.build_sentence_fixed"
_shim_name = __name__
