...
# Original file moved to: services.learning.learning_context
# This shim:
...
#     target module, so runtime code inside services.learning.learning_context that reads module-level
...
_target = _importlib.import_module("services.learning.learning_context")
_target_name = "services.learning.learning_context"
_shim_name = __name__
