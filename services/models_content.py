...
# Original file moved to: services.models.content
# This shim:
...
#     target module, so runtime code inside services.models.content that reads module-level
...
_target = _importlib.import_module("services.models.content")
_target_name = "services.models.content"
_shim_name = __name__
