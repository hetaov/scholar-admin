...
# Original file moved to: services.learning.learning_scheduler
# This shim:
...
#     target module, so runtime code inside services.learning.learning_scheduler that reads module-level
...
_target = _importlib.import_module("services.learning.learning_scheduler")
_target_name = "services.learning.learning_scheduler"
_shim_name = __name__
