...
# Original file moved to: services.providers.volcano
# This shim:
...
#     target module, so runtime code inside services.providers.volcano that reads module-level
...
_target = _importlib.import_module("services.providers.volcano")
_target_name = "services.providers.volcano"
_shim_name = __name__
