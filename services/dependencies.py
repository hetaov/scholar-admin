...
# Original file moved to: services.infra.dependencies
# This shim:
...
#     target module, so runtime code inside services.infra.dependencies that reads module-level
...
_target = _importlib.import_module("services.infra.dependencies")
_target_name = "services.infra.dependencies"
_shim_name = __name__
