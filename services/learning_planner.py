...
# Original file moved to: services.learning.learning_planner
# This shim:
...
#     target module, so runtime code inside services.learning.learning_planner that reads module-level
...
_target = _importlib.import_module("services.learning.learning_planner")
_target_name = "services.learning.learning_planner"
_shim_name = __name__
