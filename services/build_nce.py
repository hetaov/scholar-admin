...
# Original file moved to: services.build.build_nce
# This shim:
...
#     target module, so runtime code inside services.build.build_nce that reads module-level
...
_target = _importlib.import_module("services.build.build_nce")
_target_name = "services.build.build_nce"
_shim_name = __name__
