...
# Original file moved to: services.providers.evaluation_engine
# This shim:
...
#     target module, so runtime code inside services.providers.evaluation_engine that reads module-level
...
_target = _importlib.import_module("services.providers.evaluation_engine")
_target_name = "services.providers.evaluation_engine"
_shim_name = __name__
