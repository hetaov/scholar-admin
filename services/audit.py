...
# Original file moved to: services.metrics.audit
# This shim:
...
#     target module, so runtime code inside services.metrics.audit that reads module-level
...
_target = _importlib.import_module("services.metrics.audit")
_target_name = "services.metrics.audit"
_shim_name = __name__
