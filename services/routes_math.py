...
# Original file moved to: services.routes.math
# This shim:
...
#     target module, so runtime code inside services.routes.math that reads module-level
...
_target = _importlib.import_module("services.routes.math")
_target_name = "services.routes.math"
_shim_name = __name__
