...
# Original file moved to: services.routes.dialogue_gen
# This shim:
...
#     target module, so runtime code inside services.routes.dialogue_gen that reads module-level
#     globals (e.g. _background_tasks, DIALOGUE_GEN_ENABLED, ...) always sees
...
_target = _importlib.import_module("services.routes.dialogue_gen")
_target_name = "services.routes.dialogue_gen"
_shim_name = __name__
