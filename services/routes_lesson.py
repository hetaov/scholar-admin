...
# Original file moved to: services.routes.lesson
# This shim:
...
#     target module, so runtime code inside services.routes.lesson that reads module-level
...
_target = _importlib.import_module("services.routes.lesson")
_target_name = "services.routes.lesson"
_shim_name = __name__
