...
# Original file moved to: services.routes.dialogue
# This shim:
...
#     target module, so runtime code inside services.routes.dialogue that reads module-level
...
_target = _importlib.import_module("services.routes.dialogue")
_target_name = "services.routes.dialogue"
_shim_name = __name__
