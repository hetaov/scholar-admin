...
# Original file moved to: services.learning.rag_retriever
# This shim:
...
#     target module, so runtime code inside services.learning.rag_retriever that reads module-level
...
_target = _importlib.import_module("services.learning.rag_retriever")
_target_name = "services.learning.rag_retriever"
_shim_name = __name__
