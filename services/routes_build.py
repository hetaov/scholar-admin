...
# Original file moved to: services.routes.build
# This shim:
...
#     target module, so runtime code inside services.routes.build that reads module-level
...
_target = _importlib.import_module("services.routes.build")
_target_name = "services.routes.build"
_shim_name = __name__
