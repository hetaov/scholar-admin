...
# Original file moved to: services.providers.translation_eval
# This shim:
...
#     target module, so runtime code inside services.providers.translation_eval that reads module-level
...
_target = _importlib.import_module("services.providers.translation_eval")
_target_name = "services.providers.translation_eval"
_shim_name = __name__
