...
# Original file moved to: services.learning.dialogue_gen_task
# This shim:
...
#     target module, so runtime code inside services.learning.dialogue_gen_task that reads module-level
#     globals (e.g. COLLECTION, TASK_TTL_MS, ...) always sees
#     the monkey-patched value, even when tests patch via the old shim path.
#   - Underscore-prefixed symbols like _build_stale_error are fully exported.
import sys as _sys
import importlib as _importlib

_target = _importlib.import_module("services.learning.dialogue_gen_task")
_target_name = "services.learning.dialogue_gen_task"
_shim_name = __name__
