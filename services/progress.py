...
# Original file moved to: services.learning.progress
# This shim:
...
#     target module, so runtime code inside services.learning.progress that reads module-level
...
_target = _importlib.import_module("services.learning.progress")
_target_name = "services.learning.progress"
_shim_name = __name__
