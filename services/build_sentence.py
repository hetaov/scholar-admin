...
# Original file moved to: services.build.build_sentence
# This shim:
...
#     target module, so runtime code inside services.build.build_sentence that reads module-level
...
_target = _importlib.import_module("services.build.build_sentence")
_target_name = "services.build.build_sentence"
_shim_name = __name__
