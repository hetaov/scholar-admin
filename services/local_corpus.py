...
# Original file moved to: services.learning.local_corpus
# This shim:
...
#     target module, so runtime code inside services.learning.local_corpus that reads module-level
#     globals (e.g. DEFAULT_SCHOLAR_ID, WEAK_MASTERY_THRESHOLD, ...) always sees
#     the monkey-patched value, even when tests patch via the old shim path.
#   - Underscore-prefixed symbols like _shim_name are fully exported.
import sys as _sys
import importlib as _importlib

_target = _importlib.import_module("services.learning.local_corpus")
_target_name = "services.learning.local_corpus"
_shim_name = __name__
