...
# Original file moved to: services.models.training
# This shim:
...
#     target module, so runtime code inside services.models.training that reads module-level
...
_target = _importlib.import_module("services.models.training")
_target_name = "services.models.training"
_shim_name = __name__
