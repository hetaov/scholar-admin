...
# Original file moved to: services.routes.admin
# This shim:
...
#     target module, so runtime code inside services.routes.admin that reads module-level
...
_target = _importlib.import_module("services.routes.admin")
_target_name = "services.routes.admin"
_shim_name = __name__
