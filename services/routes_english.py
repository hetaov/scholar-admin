...
# Original file moved to: services.routes.english
# This shim:
...
#     target module, so runtime code inside services.routes.english that reads module-level
...
_target = _importlib.import_module("services.routes.english")
_target_name = "services.routes.english"
_shim_name = __name__
