...
# Original file moved to: services.routes.ai
# This shim:
...
#     target module, so runtime code inside services.routes.ai that reads module-level
...
_target = _importlib.import_module("services.routes.ai")
_target_name = "services.routes.ai"
_shim_name = __name__
