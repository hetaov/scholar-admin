...
# Original file moved to: services.models.scholar_book
# This shim:
...
#     target module, so runtime code inside services.models.scholar_book that reads module-level
...
_target = _importlib.import_module("services.models.scholar_book")
_target_name = "services.models.scholar_book"
_shim_name = __name__
