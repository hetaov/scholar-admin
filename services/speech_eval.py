...
# Original file moved to: services.providers.speech_eval
# This shim:
...
#     target module, so runtime code inside services.providers.speech_eval that reads module-level
...
_target = _importlib.import_module("services.providers.speech_eval")
_target_name = "services.providers.speech_eval"
_shim_name = __name__
