...
# Original file moved to: services.infra.database
# This shim:
...
#     target module, so runtime code inside services.infra.database that reads module-level
...
_target = _importlib.import_module("services.infra.database")
_target_name = "services.infra.database"
_shim_name = __name__
