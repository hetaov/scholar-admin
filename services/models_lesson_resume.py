...
# Original file moved to: services.models.lesson_resume
# This shim:
...
#     target module, so runtime code inside services.models.lesson_resume that reads
#     module-level globals (e.g. AUTH_MODE, LLM_JUDGE_MODEL, _call_judge, ...) always sees
...
_target = _importlib.import_module("services.models.lesson_resume")
_target_name = "services.models.lesson_resume"
_shim_name = __name__
