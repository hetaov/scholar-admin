...
# Original file moved to: services.routes.eval
# This shim:
...
#     target module, so runtime code inside services.routes.eval that reads module-level
...
_target = _importlib.import_module("services.routes.eval")
_target_name = "services.routes.eval"
_shim_name = __name__
