...
# Original file moved to: services.learning.dialogue
# This shim:
...
#     target module, so runtime code inside services.learning.dialogue that reads module-level
...
_target = _importlib.import_module("services.learning.dialogue")
_target_name = "services.learning.dialogue"
_shim_name = __name__
