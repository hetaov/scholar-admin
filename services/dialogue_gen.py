...
# Original file moved to: services.providers.dialogue_gen
# This shim:
...
#     target module, so runtime code inside services.providers.dialogue_gen that reads module-level
#     globals (e.g. SUPPORTED_CONTENT_TYPES, RECALL_MAX, ...) always sees
#     the monkey-patched value, even when tests patch via the old shim path.
#   - Underscore-prefixed symbols like _call_dialogue_llm_sync are fully exported.
import sys as _sys
import importlib as _importlib

_target = _importlib.import_module("services.providers.dialogue_gen")
_target_name = "services.providers.dialogue_gen"
_shim_name = __name__
