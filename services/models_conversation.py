...
# Original file moved to: services.models.conversation
# This shim:
...
#     target module, so runtime code inside services.models.conversation that reads module-level
...
_target = _importlib.import_module("services.models.conversation")
_target_name = "services.models.conversation"
_shim_name = __name__
