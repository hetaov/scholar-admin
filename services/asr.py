...
# Original file moved to: services.providers.asr
# This shim:
...
#     target module, so runtime code inside services.providers.asr that reads module-level
...
_target = _importlib.import_module("services.providers.asr")
_target_name = "services.providers.asr"
_shim_name = __name__
