...
# Original file moved to: services.routes.conversation
# This shim:
...
#     target module, so runtime code inside services.routes.conversation that reads module-level
...
_target = _importlib.import_module("services.routes.conversation")
_target_name = "services.routes.conversation"
_shim_name = __name__
