...
# Original file moved to: services.routes.tracking
# This shim:
...
#     target module, so runtime code inside services.routes.tracking that reads module-level
...
_target = _importlib.import_module("services.routes.tracking")
_target_name = "services.routes.tracking"
_shim_name = __name__
