...
# Original file moved to: services.models.learning
# This shim:
...
#     target module, so runtime code inside services.models.learning that reads module-level
...
_target = _importlib.import_module("services.models.learning")
_target_name = "services.models.learning"
_shim_name = __name__
