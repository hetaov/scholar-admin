"""一次性脚本：创建 `translation_task` 集合（幂等）

用法（在 scholar-admin 项目根目录执行）：
    python -m scripts.init_translation_task_collection
    # 或
    python scripts/init_translation_task_collection.py
...
from services.translation_task import COLLECTION  # noqa: E402
